...
session_start();
//var_dump($_SESSION);
if (isset ($_SESSION["admin_login_id"]) && isset ($_SESSION["admin_login_key"])) {
  $loggedin_id = $_SESSION["admin_login_id"];
  $loggedin_key = $_SESSION["admin_login_key"];
  $loggedin_username = $_SESSION["admin_login_name"];
} else {
...
<body>
  ...
  <nav class="navbar">
    <div class="logo_item">
      ...
      <img src="assets/images/logo b.png" alt=""></i>ENCORE ESPORTS
    </div>
